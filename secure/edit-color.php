                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                <form action="controller/color-update.php" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Color Name</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1"  placeholder="Color Name" name="color_name" value="<?php echo $brands[0]['color_name']?>">
                                    </div>

                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="btn">Submit</button>
                                    </div>
                                    <input type="hidden" name="color_id" value="<?php echo $id?>">
                                </form>
                            </div>
                        </div>
                    </div>
