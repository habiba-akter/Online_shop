                                        ...
                                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-category.php?id=<?php echo base64_encode( $category['category_id']);?>" class="btn btn-info">
                                                            Edit
                                                        </a>
                                                        <a href="controller/category-delete.php?id=<?php echo base64_encode( $category['category_id']);?>" class="btn btn-danger" onclick="return confirm('Are you sure');">
                                                            Delete
                                                        </a>
                                                    </td>
                                                </tr>
