                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                ...
                                <form action="controller/product-save.php" method="POST" enctype="">
                                    ...
                                    <input type="checkbox" id="basic_checkbox_<?php echo $key; ?>" name="size[]" value="<?php echo $size['size_name']; ?>"  />
                                    <label for="basic_checkbox_<?php echo $key; ?>"><?php echo $size['size_name']; ?></label>
                                    <?php } ?>
