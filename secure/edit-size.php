                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                <form action="controller/size-update.php" method="POST">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Size</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1"  placeholder="Size" name="size_name" value="<?php echo $brands[0]['size_name']?>">
                                    </div>

                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="btn">Submit</button>
                                    </div>
                                    <input type="hidden" name="size_id" value="<?php echo $id?>">
                                </form>
                            </div>
                        </div>
                    </div>
