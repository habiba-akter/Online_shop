                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                ...
                                <form action="controller/category-save.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="textarea_editor form-control" rows="15" placeholder="Enter text ..." name="category_description"></textarea>
                                    </div>
