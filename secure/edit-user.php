...
$getUser = $con_obj->getAllData("SELECT * FROM user WHERE user_id = '$id'");
                                ...
                                <form action="controller/user-update.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="user_status">
                                            <option value="1" <?php if($getUser[0]['user_status']=='1')  echo "selected";?>>Active</option>
                                            <option value="0" <?php if($getUser[0]['user_status']=='0')  echo "selected";?>>Inactive</option>
                                        </select>
                                    </div>
